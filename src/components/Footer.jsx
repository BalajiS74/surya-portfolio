      ...
      <div className="footer-container">
        ...
        <div className="footer-content">
          ...
          <div className="footer-contact">
            ...
            <ul className="footer-contact-list">
              <li>
                ...
                >
                  <path
                    d="M22 6L12 13L2 6M22 6V18C22 19.1046 21.1046 20 20 20H4C2.89543 20 2 19.1046 2 18V6M22 6L12 13M2 6L12 13M2 6L2 18M22 6L22 18"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                ...
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=prabhassurya601@gmail.com"
                  target="_blank"
                >
                  prabhassurya601@gmail.com
                </a>
              </li>
              <li>
                <svg
          ...
          <div className="footer-social">
            ...
            <div className="social-links">
              ...
              <a
                href="https://www.instagram.com/die_ceo/"
                className="social-icon"
        ...
        <div className="footer-bottom">
          <p className="copyright">
            &copy; {currentYear} Surya Prabha. All rights reserved.
          </p>
